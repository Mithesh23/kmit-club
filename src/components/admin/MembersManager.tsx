...
export const MembersManager = ({ clubId }: MembersManagerProps) => {
  ...
  // Extract Years and Branches dynamically
  ...
  }, [approvedRegistrations, filterYear, filterBranch]);
...
<div className="space-y-4 p-4 border rounded-lg">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h4 className="font-semibold">Executive Members</h4>
            {members && members.length > 0 && (
              <Button size="sm" variant="outline" onClick={handleDownloadMembers}>
                <Download className="h-4 w-4 mr-2" />
                Download
              </Button>
            )}
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              {approvedRegistrations.length > 0 && (
                <Button size="sm" variant="outline" onClick={handleDownloadApproved}>
                  <Download className="h-4 w-4 mr-2" />
                  Download
                </Button>
              )}
          ...
          <ScrollArea className="h-[400px]">
            {isLoadingRegistrations ? (
                ...
                {filteredApproved.map((reg) => (
                  <div key={reg.id} className="p-3 border rounded-lg space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-sm text-muted-foreground">
                        <span className="font-medium">Roll:</span> {reg.roll_number}
                      </div>

                      <div className="text-sm text-muted-foreground">
                        <span className="font-medium">Year:</span> {reg.year} | 
                        <span className="font-medium ml-1">Branch:</span> {reg.branch}
                      </div>
                    </div>
              ...
              <p className="text-muted-foreground text-center py-8">No students match the selected filters.</p>
            )}
          </ScrollArea>
