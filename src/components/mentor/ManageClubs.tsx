...
export default function ManageClubs() {
  ...
  const getClubMembers = (clubId: string) => members.filter((m) => m.club_id === clubId);
  const getClubReports = (clubId: string) => reports.filter((r) => r.club_id === clubId);
